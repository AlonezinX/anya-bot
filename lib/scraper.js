...
function lirik(text){
	return new Promise(async(resolve, reject) => {
   		axios.get('https://www.musixmatch.com/search/' + text)
   		.then(async({ data }) => {
   		const $ = cheerio.load(data)
   		const hasil = {};
...
module.exports = { pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, umma, ringtone, lirik, igstalk, styletext }
